...
const logCurrentTimeAndWeatherByLocationNameOrPostalCode = async inputArrayData => {
    if ( !isValidInputArray(inputArrayData) ) return ERROR('Invalid input array, input must be an array of values', 400)
...
export {
    appEntry,
    logCurrentTimeAndWeatherByLocationNameOrPostalCode
}